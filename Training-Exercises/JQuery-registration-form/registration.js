$(document).ready(function () {
    ...
    $('#submitButton').click ( function(e) {
        ...
        if(firstname === ''){
         ...
         // lastname validation
         if(lastname === ''){
            $('.lnameerror').text('Enter your lastname');
            $('.lnameerror').css('color' , 'red');
            $('#lastname').css('border', '1px solid red');
        } else if (firstname.length < 3) {
            $('.lnameerror').text('Name must be in 3 characters');
            $('.lnameerror').css('color' , 'red');
            $('#lastname').css('border', '1px solid red');
        } else {
            $('.lnameerror').text('');
        ...
        if(employeeid === ''){
            $('.employeeiderror').text('Enter your employee ID');
            $('.employeeiderror').css('color' , 'red');
            $('#employeeid').css('border', '1px solid red');
        } else if (employeeid.length === 7) {
            $('.employeeiderror').text('');
            $('#employeeid').css('border', '1px solid green');
        } else {
            $('.employeeiderror').text('Enter your 7 digit employeeID');
            $('.employeeiderror').css('color' , 'red');
            $('#employeeid').css('border', '1px solid red');
        }
